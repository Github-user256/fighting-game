...
class Sprite {
    ...
    draw(){
        c.drawImage(
            this.image,
            this.framesCurrent * (this.image.width / this.framesMax),  //crop point
            0,  //crop point
            this.image.width / this.framesMax,   //crop code
            this.image.height ,  //crop code
...
console.log(this.sprites);
    ...
    update(){
        ...
        if(this.position.y + this.height + this.velocity.y >= canvas.height - 96){
            this.velocity.y = 0
            this.position.y = 330
        } else  //stop players from sinking off screen
